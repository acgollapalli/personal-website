...
I hope you have found a bit of delight in my website—and that you're not berating my
poor efforts at frontend development. Please be kind, I wrote the markdown
compiler [overnight](/blog/hello-world/markdown-compiler),
and it's accordingly atrocious. I may say that I'm fullstack, because it's marketable,
but really I'm much more of a backend developer at heart. Data transformation, querying,
and API's are things that I actually seem to enjoy, for reasons I still don't understand.
Maybe it's just because it's what I learned first.
...
a concept, let alone a status symbol. The thing that was the height of cool was having
your own website. So I'm building this one, just for fun. Just for me.

>It's always been cool to have your own website.

I know job applications (blasted things! They should just have bots that rank GitHub
repos based on complexity and recruit people based on their personal projects... not
that I'd be any better for it) ask for personal websites sometimes, and that was my
initial justification for building one. But I'm having fun, so I dont think that
putting up a resume and brief introduction is going to cut it for me.
...
in any professional setting ever again. I was just done. I thought office life bred mean, lowly
...
Heaven help me, I actually love the thought of being at an engineering org and doing
crazy, difficult stuff, like Netflix, or Cloudflare, or even founding my own company.
Whatever else I might do in my life, I really do like programming. I want to be good
at it. I want to be **great** at it.
...
honesty in that—respect it, even. But for others, our desires are a bit more subtle. It's
not about status in the monkey-brain, top of the hierarchy sense—serotonin
...
cultures that followed it in descent of intellect and spirit, ours included. It wasn't regarded
...
excellence will be jarred by the blow.
...
important to include it. Beowulf swam the English Channel, fought monsters and dragons,
...
that culture. Beowulf did so in a manner worthy of bards singing his song—for millenia. Those lines
...
mere tinkerers, hobbyists, children with their toys, dilettantes (a word that ought to be reclaimed),
...
But it's still early days. And people don't really *get* it yet. Programmers,
good ones (or me) want to be in the same category, but it's early days.
...
little opportunity there can be to display excellence in the core work of our
profession. But sometimes management attitudes towards our attempts can be the
most brutal thing of all.
...
or prestige. People who work at places that expect you not to care about those things
don't expect you to have self-respect either. I've tried it. It didn't work. FYPM
as the old artists adage goes.

But what do I want most? I want to work with the best people, doing the best stuff,
at the highest level. If I have to change fields of endeavor entirely to do that,
then I will. But if I have an opportunity to do that, that leverages the last
...
I guess there's also a bit of me giving software another shot. Reeally putting my
name to it. I'm out on the open web as a software developer. Yipee.

Also, I guess there's the admiration factor. Paul Graham has a website. Eric S. Raymond
