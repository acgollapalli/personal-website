...
export function NavActions(){
  ...
  <div className="flex items-center gap-2 text-sm">
	...
	<Link href="https://x.com/DrillThruTheSky">
	  <Button variant="ghost" size="icon" className="h-7 w-7" title="Oh, you're one of THOSE, huh?">
		<Image className="invert dark:invert-0" src={"/x-logo/logo.svg"} alt={"x dot com"} width={16} height={16}/> 
	  </Button>
	</Link>
